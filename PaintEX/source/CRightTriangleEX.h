#pragma once
#ifndef CRightTriangleEX_H
#define CRightTriangleEX_H
#include <math.h>
#include "CShapeEX.h"
class CRightTriangleEX:public CShapeEX			//	Class name declaration
{
private:
	POINTS m_xPt1, m_xPt2, m_xPt3;				//	the triangle's three peaks
public:
	CRightTriangleEX();							//	Constructor				
...
//	Xac dinh xem mot diem co nam trong tracker hay khong
...
//  PURPOSE: Calculate the triangle's coordinates
	bool InsideTriangle(POINTS pt)
		{
			double dbA1,dbA2,dbA3,dbB1,dbB2,dbB3,dbC1,dbC2,dbC3;
			...
			double dbValue1,dbValue2,dbValue3, dbValue1Pt,dbValue2Pt,dbValue3Pt;
